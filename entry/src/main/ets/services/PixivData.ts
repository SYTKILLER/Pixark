...
import { tagCollectionService } from '../common/utils/TagCollectionService';
...
export class PixivData {
  ...
  /**
   * 列表请求统一封装：屏蔽关键词过滤 + 空页追载
   * - 命中屏蔽词的作品在获取阶段即被移除，不进入任何列表
   * - 整页被滤光且仍有下一页时自动续取（最多连续 2 页），避免翻页空白
   */
  private async fetchListWithFilter(
    url: string,
    params: Record<string, any> | undefined,
    nextUrl: string | undefined,
    kind: 'illusts' | 'novels'
  ): Promise<PixivListResult> {
    await tagCollectionService.ready();
    const data = await this.fetchApi<PixivListResult>(url, params, nextUrl);
  ...
  async searchIllust(
    ...
    return this.fetchListWithFilter('/v1/search/illust', params, nextUrl, 'illusts');
  }
  ...
  async getPopularPreview(keyword: string): Promise<PixivListResult> {
    ...
    return this.fetchListWithFilter(
  ...
  async getRecommended(
    ...
    return this.fetchListWithFilter('/v1/illust/recommended', params, nextUrl, 'illusts');
  }
  ...
  async getMangaRecommended(nextUrl?: string): Promise<PixivListResult> {
    ...
    return this.fetchListWithFilter('/v1/manga/recommended', params, nextUrl, 'illusts');
  }
  ...
  async getFollowIllusts(
    ...
    return this.fetchListWithFilter('/v2/illust/follow', params, nextUrl, 'illusts');
  }
  ...
  async getRelatedIllusts(
    ...
    return this.fetchListWithFilter('/v2/illust/related', params, nextUrl, 'illusts');
  }
  ...
  async walkthroughIllusts(): Promise<PixivListResult> {
    return this.fetchListWithFilter('/v1/walkthrough/illusts', undefined, undefined, 'illusts');
  }
  ...
  async searchNovel(
    ...
    return this.fetchListWithFilter('/v1/search/novel', params, nextUrl, 'novels');
  }
  ...
  async getNovelRanking(
    ...
    const params = { mode, date, filter: 'for_android' };
    return this.fetchListWithFilter('/v1/novel/ranking', params, nextUrl, 'novels');
  }
  ...
  async getNovelRecommended(nextUrl?: string): Promise<PixivListResult> {
    ...
    return this.fetchListWithFilter('/v1/novel/recommended', params, nextUrl, 'novels');
  }
  ...
  async getNovelFollow(
    ...
    return this.fetchListWithFilter('/v1/novel/follow', { restrict }, nextUrl, 'novels');
  }
  ...
  async getUserNovels(
    ...
    return this.fetchListWithFilter('/v1/user/novels', params, nextUrl, 'novels');
  }
  ...
  async getUserIllusts(
    ...
    return this.fetchListWithFilter('/v1/user/illusts', params, nextUrl, 'illusts');
  }
  ...
  async getUserBookmarks(
    ...
    return this.fetchListWithFilter('/v1/user/bookmarks/illust', params, nextUrl, 'illusts');
  }
  ...
  async getUserBookmarkNovel(
    ...
    return this.fetchListWithFilter('/v1/user/bookmarks/novel', params, nextUrl, 'novels');
  }
